...
module.exports = (grunt) ->
    ...
    copy:
      dist:
        files: [{
            ...
            cwd: "<%= yeoman.app %>"
            dest: "<%= yeoman.dist %>"
            src: ["*.{ico,txt}", "images/{,*/}*.{gif,svg,webp,png,jpg,jpeg,ico}", "fonts/*"]
          },
          {
            expand: true
            flatten: true
  ...
  grunt.registerTask "build", ["clean:dist", "coffee", "jade", "stylus", "useminPrepare", "concat", "copy", "cssmin", "htmlmin", "uglify", "rev", "usemin", "replace"]
